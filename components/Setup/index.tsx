...
import { Copy, Check, RefreshCw, ChevronDown, ExternalLink } from 'lucide-react';
...
export default function SetupContainer() {
  ...
  const refreshAccessKey = () => {
    setIsRefreshing(true);
    // Simulate API call to refresh access key
    setTimeout(() => {
      setUser({
        ...user,
        accessKey: 'sui_access_' + Math.random().toString(36).substring(2, 15)
      });
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <p className="text-lg text-blue-100/80 mb-10">
        Configure Sui Butler to connect with your MCP-compatible AI assistants
      </p>
